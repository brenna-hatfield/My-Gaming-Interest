...
class MasterViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        listArray = ["Diablo III", "Elder Scrolls Online", "Final Fantasy VII", "Final Fantasy A Realm Reborn", "Final Fantasy X", "Final Fantasy XV", "Kingdom Hearts 2", "Skyrim", "Kingdom Hearts Birth By Sleep", "Maplestory"]
